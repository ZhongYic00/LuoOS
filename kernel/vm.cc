...
VMOMapper::VMOMapper(Arc<VMO> vmo){
    ...
    auto mapping=PageMapping{kInfo.segments.mapper.second,vmo->len(),0,vmo,PageTableEntry::fieldMasks::r|PageTableEntry::fieldMasks::w|PageTableEntry::fieldMasks::v,PageMapping::MappingType::file,PageMapping::SharingType::shared};
